...
$dbss=array();
$dbss['type']='postgre';             // database type, *lowercase* (options: mysql, mysqli, postgre, sqlite, pdo_sqlite)
$dbss['host']='localhost';         // database host (in most cases 'localhost')
$dbss['user']='admin';                  // database user (not used with sqlite)
$dbss['pass']='admin';                  // database password  (not used with sqlite)
$dbss['name']='blabim';                  // Database name [mysql, postgre]. Note that the installation script cannot create a database for you!
